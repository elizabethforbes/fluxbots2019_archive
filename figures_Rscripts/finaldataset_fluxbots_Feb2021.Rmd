...
fluxdata_20s_2019 <- subset(df_flux, year == 2019) # 23195 rows; 1366 removed with wrong year
...
sum(fluxdata_20s_2019_qaqc$flux_umol_m2_sec < 0, na.rm = TRUE) # 763 below zero in 'clean'
...
sum(fluxdata_20s_2019_qaqc$flux_umol_m2_sec < -1) # only 112
sum(fluxdata_20s_2019_qaqc$flux_umol_m2_sec > -1 &
      fluxdata_20s_2019_qaqc$flux_umol_m2_sec < 0) # 651; the vast majority of our negative fluxes are quite small (between 0 and -1)
